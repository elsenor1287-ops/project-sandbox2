...
function ProposalHistory({ proposals }: { proposals: Proposal[] }) {
...
function CompilerOutput({ compileResult, content }: CompilerOutputProps) {
  return (
    <div className="card p-6">
      <h2 className="text-lg font-semibold text-primary-200 mb-4 flex items-center gap-2">
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        {/* Output */}
        <CompilerOutput compileResult={compileResult} content={content} />
      </div>
